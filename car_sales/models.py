...
class Vehicle(models.Model):
    ...
    rent_type = models.CharField(max_length=50,choices=RENT_TYPE, default="With Driver")
    drive_type = models.CharField(max_length=50,choices=DRIVE_TYPE, default="Pay And Drive")
