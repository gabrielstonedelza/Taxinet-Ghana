    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Passenger', 'Passenger'), ('Driver', 'Driver'), ('Investor', 'Investor'), ('Administrator', 'Administrator')], default='Passenger', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='verified_profile', to='taxinet_users.passengerprofile')),
            ],
        ),
        migrations.CreateModel(
