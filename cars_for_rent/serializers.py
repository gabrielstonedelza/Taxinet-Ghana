...
class CarsForRentSerializer(serializers.ModelSerializer):
    class Meta:
        model = CarsForRent
        fields = ['id','name','engine_type','seater','transmission','car_model','picture','date_added','get_car_pic','description','color','drive_type','outside_ksi','k200','k300','k400','k500','k600','kk200']
