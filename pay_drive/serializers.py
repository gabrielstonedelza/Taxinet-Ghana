...
class AddToApprovedPayAndDriveSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','user','pay_and_drive','assigned_driver','date_approved','get_car_name','get_driver_type','get_pick_up_date','get_payment_period','get_total_price','get_date_requested','get_car_pic']
