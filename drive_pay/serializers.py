...
class AddToApprovedDriveAndPaySerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id','user','drive_and_pay','assigned_driver','date_approved','get_car_name','get_drive_type','get_pick_up_date','get_drop_off_date','get_payment_period','get_total_price','get_date_requested','get_drive_type','user_tracker_sim']
